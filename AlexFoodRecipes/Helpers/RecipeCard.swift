...
//правый нижний угол сделать с закладкой, обработать напильникмо ))т   2 миин




final class RecipeCard: UIView {
    
    
    //    view
    // foodImageView - картинка рецепта
    // ratingImageVIew (image, label) - рейтинг
    
    //background view
    //recipe Name - UIBUtton   - кнопка с названием рецепта
    // cooking time label   - время готовки
    // book mark - закладка
    ...
    //    private let recipeNameButton: UIButton = {
    //        let button = UIButton()
    ////        button.backgroundColor = .red
    //        button.setTitle("Classic Greek Salad", for: .normal)
    //        button.frame = CGRect(x: 0, y: 0, width: 130, height: 42)
    ////        button.font
    //        button.setTitleColor(Constants.FontsColors.fontColorGrey1, for: .normal)
    //        return button
    //    }()
    ...
    private func setupUI() {
        ...
        backgroundColorView.snp.makeConstraints { make in
            ...
            //            make.top.equalTo(foodImage.snp.centerY)
