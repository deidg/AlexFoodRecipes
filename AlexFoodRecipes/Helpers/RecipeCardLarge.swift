...
final class RecipeCardLarge: UICollectionViewCell {
    ...
    private let foodImage: UIImageView = {
        ...
        image.layer.cornerRadius = 55 // Half of width (110) for circular image
    ...
    // This is the new configure function
    func configure(with recipe: Recipe) {
        ...
        // Set the rating
        ratingLabel.text = String(format: "%.1f", recipe.rating)
        
        // Load the image (assuming you use a library like SDWebImage or similar)
...
//            shadowLayer.path = UIBezierPath(roundedRect: image.bounds,
//                                            cornerRadius: image.layer.cornerRadius).cgPath
//        shadowLayer.fillColor = image.backgroundColor?.cgColor
...
//        
//        
//        image.layer.insertSublayer(shadowLayer, at: 0)
//        
