...
//            self.delegate
    ...
    //        showChosenCuisine(chosenCuisine: <#String#>)
...
//            let cuisinesButtonScroller = CustomSegmentedControl(buttonsArray: listOfCuisineNames)
////            let cuisinesButtonScroller = CustomSegmentedControl()
//
//////                   cuisinesButtonScroller.delegate = self // Устанавливаем себя в качестве делегата
//            cuisinesButtonScroller.showCuisineDelegate = self
////            cuisinesButtonScroller.delegate = self
//
//            print("Delegate for CustomSegmentedControl is set")
...
//                   view.addSubview(cuisinesButtonScroller)
    ...
    //        reloadData()
        ...
        @objc func showChosenCusine (sender: UIButton) {
            print("\(sender) cuisine chosen")
        }
